...
public class Avada_Kedavra implements Listener  {
...
public void onLeftClick(PlayerInteractEvent e) {
	...
	if(canDoLocalSpell.get(e.getPlayer().getName())) {
		...
		Entity entity = null;
		entity = API.getThatEntity(e.getPlayer(), 15, ParticleEffect.VILLAGER_HAPPY, 50);
		if(entity != null) {
		...
		API.broadcastSpell(e.getPlayer(), Spell, "DARK_GREEN" );
