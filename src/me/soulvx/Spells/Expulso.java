...
public void onLeftClick(PlayerInteractEvent e) {
	...
	if(canDoLocalSpell.get(e.getPlayer().getName())) {
		...
		Block block = API.getThatBlock(e.getPlayer(), 20, ParticleEffect.SMOKE_NORMAL, 30);
		e.getPlayer().getWorld().createExplosion(block.getLocation(), (float) API.getRandomNumber(2, 6));
