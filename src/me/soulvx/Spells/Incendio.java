...
public void onLeftClick(PlayerInteractEvent e) {
	...
	if(canDoLocalSpell.get(e.getPlayer().getName())) {
		...
		Block b = API.getThatBlock(e.getPlayer(), 20, ParticleEffect.FLAME, 50);
		if(b.getType() != Material.AIR) {
			e.getPlayer().getWorld().createExplosion(b.getX(), b.getY(), b.getZ(), 3f, true, false);
		}
